...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(1946675686445230686)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1946692194690576582)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1833508978128611875)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1533322911538090035)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1533330378211091425)
,p_plugin_attribute_id=>wwv_flow_api.id(1533322911538090035)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1279571557242116608)
,p_plugin_attribute_id=>wwv_flow_api.id(1533322911538090035)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1536210297903273842)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'APPLICATION'
...
,p_show_in_wizard=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(1946692194690576582)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1536232731569300890)
,p_plugin_attribute_id=>wwv_flow_api.id(1536210297903273842)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1536233180730304069)
,p_plugin_attribute_id=>wwv_flow_api.id(1536210297903273842)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(725798986762068995)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(775036149751686706)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(801293750228712352)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'APPLICATION'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(775036149751686706)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(640467164238160129)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(199597306670227510)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'APPLICATION'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(1536210297903273842)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1276204626182391236)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1946717401313566254)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1946719589236571927)
,p_plugin_attribute_id=>wwv_flow_api.id(1946717401313566254)
,p_display_sequence=>40
,p_display_value=>'PDF (pdf)'
,p_return_value=>'pdf'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1946848404054499986)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(1946717401313566254)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1774856837434723194)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1741376108935045118)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1741381232035046542)
,p_plugin_attribute_id=>wwv_flow_api.id(1741376108935045118)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1741381595225048092)
,p_plugin_attribute_id=>wwv_flow_api.id(1741376108935045118)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(940771785109588060)
,p_plugin_attribute_id=>wwv_flow_api.id(1741376108935045118)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(802693155519710638)
,p_plugin_attribute_id=>wwv_flow_api.id(1741376108935045118)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1741381989746079423)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(1741376108935045118)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(804187357455035909)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
...
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(1078671963616773400)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_name=>'aop-file-error'
,p_display_name=>'AOP Print File Error'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(1078672434101773400)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
,p_name=>'aop-file-progress'
,p_display_name=>'AOP Print File Progress'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(1078672808682773400)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(206745099971258285)
,p_plugin_id=>wwv_flow_api.id(1946675686445230686)
