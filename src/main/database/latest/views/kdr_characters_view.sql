...
select  ch.char_id,
        ...
        get_total_race_xp(ch.char_id)                               total_race_xp,
        ...
        get_total_event_xp(ch.char_id)                              as TOTAL_EVENT_XP,
        get_total_quest_xp(ch.char_id)                              as TOTAL_QUEST_XP,
        get_total_xp_spend_skills(ch.char_id)                       as "xp_spend_skills",
        get_total_xp_spend_spells(ch.char_id)                       as "xp_spend_spells",
        get_total_xp_spend_prayers(ch.char_id)                      as "xp_spend_prayers",
        get_total_mana_divinity_gain(ch.char_id)                    as "total_mana_divinity_gain"
