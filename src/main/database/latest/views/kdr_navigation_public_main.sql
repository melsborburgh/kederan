set define off
/
CREATE OR REPLACE FORCE EDITIONABLE VIEW KDR_NAVIGATION_PUBLIC_MAIN (LEVEL_VALUE, LABEL_VALUE, TARGET_VALUE, IS_CURRENT, IMAGE_VALUE, IMAGE_ATTR_VALUE, IMAGE_ALT_VALUE, ATTRIBUTE1, ATTRIBUTE2, ATTRIBUTE3,TOOLTIP) AS
  select
